...
Change the simulation-popup at the end.

Instead of clicking "Try again" at the end,
if the player reaches above the `profit` threshold, (hardcoded in the level,)
the player may choose to go to next level.

If the player doesn't reach required profit, they click `Try Again`.
